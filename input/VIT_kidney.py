...
_NEURON_1 = 16
#_NEURON_1 = 128
_NEURON_2 = 3 #n_classes #ABM, antes ponia = 3
_EMBEDDING_ = 32

_EPOCHS = 1

batch_size= 4 #8 #32# 32#64 para disney, usar 8 porque hay pocas imagenes. para caltech usar 32
...
my_split=0.3 # un 20% del conjunto de train lo usamos para validar
lr=1e-9 #1e-2 #1e-4 # learning rate  (default de keras es 0.001 es decir 1e-3)
