...
(x_train_2_subred, y_train_2_subred), (x_val_2_subred, y_val_2_subred) = keras.datasets.imdb.load_data(num_words=vocab_size)
print(len(x_train_2_subred), "Training sequences")
print(len(x_val_2_subred), "Validation sequences")
x_train_2_subred = keras.preprocessing.sequence.pad_sequences(x_train_2_subred, maxlen=maxlen)
x_val_2_subred = keras.preprocessing.sequence.pad_sequences(x_val_2_subred, maxlen=maxlen)

#barajamos datos por si vienen ordenados
idx = np.random.permutation(len(x_train_2_subred))
x_train_2_subred = x_train_2_subred[idx]
y_train_2_subred = y_train_2_subred[idx]

#SKYNNET:BEGIN_BINARYCLASS_ACC_LOSS
_DATA_TRAIN_X = x_train_2_subred
_DATA_TRAIN_Y = y_train_2_subred
_DATA_VAL_X = x_val_2_subred
_DATA_VAL_Y = y_val_2_subred
_DATA_TEST_X = x_train_2_subred
_DATA_TEST_Y = y_train_2_subred
...
model.fit(
    _DATA_TRAIN_X, _DATA_TRAIN_Y, batch_size=_BATCH, epochs=_EPOCHS, validation_data=(_DATA_VAL_X, _DATA_VAL_Y)
)
